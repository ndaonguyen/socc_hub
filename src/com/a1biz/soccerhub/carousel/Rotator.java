...
public class Rotator {
    ...
    private float mCoeffVelocity = 0.01f; // 0.05
    private float mVelocity;
    
    private static final int DEFAULT_DURATION = 250; // 250
    private static final int SCROLL_MODE = 0;  //0
    private static final int FLING_MODE = 1;   //1
    
    private final float mDeceleration = 240.0f; // 240.0f
